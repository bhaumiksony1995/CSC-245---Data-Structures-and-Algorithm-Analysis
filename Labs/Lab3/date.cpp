...
void Date CopyFrom operator=(const Date& otherDate)
{
    mo = otherDate.mo;
    day = otherDate.day;
    yr = otherDate.yr;
...
bool Date LessThan operator<(const Date& otherDate) const
{
	if (yr < otherDate.yr)
		return true;
...
bool Date EqualTo operator==(const Date& otherDate) const
{
